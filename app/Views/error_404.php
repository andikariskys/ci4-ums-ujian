                ...
                <div class="row justify-content-center w-100">
                    <div class="col-lg-4">
                        <div class="text-center">
                            <img src="<?= base_url('assets/images/backgrounds/error404.webp') ?>" alt="modernize-img" class="img-fluid" width="500">
                            <h1 class="fw-semibold mb-7 fs-9">Opps!!!</h1>
                            <h4 class="fw-semibold mb-7">This page you are looking for could not be found.</h4>
                            <a class="btn btn-primary" href="<?= route_to('login') ?>" role="button">Go Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
